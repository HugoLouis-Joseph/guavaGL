  ...
  public static long checkedPow(long b, int k) {
    ...
    while (true) {
      switch (k) {
        ...
        default:
          // Multiplication is done when k is odd since we shift its value, dividing the amount of iterations by two everytime (so it results in log2(k) multiplications). This works as b is multiplied by itself everytime.
          if ((k & 1) != 0) {
